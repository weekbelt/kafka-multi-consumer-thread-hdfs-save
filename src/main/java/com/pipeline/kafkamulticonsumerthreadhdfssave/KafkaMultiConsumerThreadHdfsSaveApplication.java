package com.pipeline.kafkamulticonsumerthreadhdfssave;

import com.pipeline.kafkamulticonsumerthreadhdfssave.consumer.ConsumerWorker;
...
public class KafkaMultiConsumerThreadHdfsSaveApplication {

    private final static Logger logger = LoggerFactory.getLogger(KafkaMultiConsumerThreadHdfsSaveApplication.class);
